...
Les données sont ensuite chargées en mémoire, en utilisant la table des pages. Ces dernières étapes sont réalisées dans le constructeur d'AddrSpace (fichier \textit{adrrspace.cc}).
